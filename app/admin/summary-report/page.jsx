    ...
    <main className="bg-gray-50 p-4 sm:p-6 lg:p-8 print:bg-white print:p-0">
      ...
      {loading&&!d?<div className="py-24 text-center text-sm text-gray-500">Building the report...</div>:d&&<div className="mx-auto max-w-7xl bg-white p-5 shadow-sm print:max-w-none print:p-0 print:shadow-none">
        ...
        <div className="grid gap-5 lg:grid-cols-2 xl:grid-cols-3">
          ...
          <Section title="Event Sales" note="An event is a sale on the day it is settled, not the day it is booked. Advances applied were collected earlier and are shown so today's cash can be told apart from today's sale." rows={[line('Recognised Revenue (net of tax)',d.events.net_revenue),line('Tax on Events',d.events.tax),line(`Gross Event Sales (${d.events.settlements||0} settled)`,d.events.gross),line('Of which advances applied',d.events.advances_applied)]}/>
