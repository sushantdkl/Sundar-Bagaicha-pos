...
export async function seatReservation(
  ...
  const result = await db.transaction(async () => {
    // Seating creates an open order, but it does not record a payment or cash
    // movement. Keep the order attached to the already-open business day even
    // when that day crosses a Nepal-date boundary; checkout remains responsible
