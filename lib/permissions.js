...
const DEFAULTS = {
  ...
  // Every new key defaults to OFF for every managed role, so nothing an
  // existing cashier or waiter can do changes until an admin grants it.
  'delivery_executives.view': { waiter: false, cashier: false, kitchen: false },
  'delivery_executives.manage': { waiter: false, cashier: false, kitchen: false },
  'delivery_executives.assign': { waiter: false, cashier: false, kitchen: false },
