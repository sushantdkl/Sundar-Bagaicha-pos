    ...
    return await this.db.transaction(async () => {
      ...
      const result = await this.db.run(`
        INSERT INTO orders (
          ...
          status, notes, customer_name, customer_phone, customer_id, party_label, business_day_id, event_id, created_at, updated_at
      ...
      `, [
        ...
        partyLabel,
        businessDayId,
        // Null for ordinary restaurant orders — which is every existing row.
        // Set only when an event releases production (lib/events/production.js).
