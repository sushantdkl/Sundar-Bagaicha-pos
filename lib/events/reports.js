...
export async function salesByChannel(db, { from, to } = {}) {
  ...
  // Restaurant: completed sales whose order is not part of an event. A credit
  // bill is still an earned sale, even though some cash will arrive later.
  ...
  // Events: gross earned sale (net revenue + tax), matching bill grand totals.
  ...
  return {
    ...
    note: 'Restaurant and event sales are gross earned sales, including customer credit. Event deposits and unsettled quotations are excluded.',
  };
}
