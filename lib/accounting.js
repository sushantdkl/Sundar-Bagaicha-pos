...
export const PAYMENT_ACCOUNT = {
  ...
  credit: '1300',
  due: '2010',
  // Not a tender. An event settlement applies an advance the customer paid
  // weeks earlier, already banked as cash or bank on the deposit date, and
  // held in 2030 since. Settling it debits 2030 — the liability clears, no
  // money moves today. It is mapped here because event bills record it as a
  // payment row so the bill's payments add up to its total, and every consumer
  // of a payment method resolves it through this table.
  advance: '2030',
};
